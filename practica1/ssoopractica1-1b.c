// pidiendo el numero n de procesos totales, crear un abanico de procesos de la forma 1padre - 1hijo - 1hijo - 1hijo
...
int main(){
    ...
    for (int i = 0; i < n; i++){
        ...
        default:
            ...
            pid = wait(&status); //aqui van llegando los padres; 
